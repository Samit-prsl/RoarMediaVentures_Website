...
export default function YtLinkPhone() {
...
const rightVariants = {
  ...
  return (
    ...
    <div className=' flex justify-center items-center h-full my-6 p-8'>
      <iframe width="760" height='215' src="https://www.youtube.com/embed/KrRHNutZC54?si=kh2xwBMlxe9MP0MS" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
    </div>
    <h1 className=' text-center text-black lg:text-4xl font-semibold text-2xl px-3 lg:px-0'>MOST OF THE <span className=' text-red-600'>BUSINESS OWNERS FACE</span> ONE OR MORE OF THESE</h1>
    <div className=' h-full px-16 py-5 lg:flex lg:justify-between lg:items-center'>
        <motion.div 
        variants={rightVariants}
        initial={rightVariants.hidden}
        whileInView={leftVariants.enter}
        transition={{ type: 'spring', stiffness: 50 }}
        exit={leftVariants.exit}  className=' flex flex-col justify-center items-center gap-4 py-5 lg:py-0'>
